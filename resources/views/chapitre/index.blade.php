...
@section('content')
    ...
    <div style="margin-bottom: 20px;">
        <a href="{{ route('chapitre.create') }}" style="
    ...
    @foreach($chapitres as $chapitre)
        <div style="border:1px solid #ccc; padding: 10px; margin: 10px 0; border-radius: 5px;">
            ...
            <p><strong>Livre :</strong> {{ $chapitre->book->nom_book }}</p>
            ...
            <div style="display: flex; gap: 10px;">
                {{-- Bouton Modifier --}}
                <a href="{{ route('chapitre.edit', $chapitre->id_chapitre) }}" style="
                ...
                {{-- Bouton Supprimer --}}
                <form action="{{ route('chapitre.destroy', $chapitre->id_chapitre) }}" method="POST" onsubmit="return confirm('Supprimer ce chapitre ?')">
                    @csrf
                    @method('DELETE')
